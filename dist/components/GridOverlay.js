...
export default function GridOverlay({ width, height, gridSize = 50, }) {
    ...
    return (_jsx("div", { style: {
            ...
            overflow: "hidden",
                ...
                top: 0,
                left: 0,
            }, children: [_jsx("defs", { children: _jsx("pattern", { id: patternId, x: offsetX, y: offsetY, width: gridSize, height: gridSize, patternUnits: "userSpaceOnUse", children: _jsx("rect", { x: gap / 2, y: gap / 2, width: squareSize, height: squareSize, fill: "rgba(0, 0, 0, 0.05)", stroke: "rgba(0, 0, 0, 0.08)", strokeWidth: "1", rx: "4", ry: "4" }) }) }), _jsx("rect", { width: "100%", height: "100%", fill: `url(#${patternId})` })] }) }));
}
