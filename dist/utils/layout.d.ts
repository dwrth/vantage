import { LayoutRect, Breakpoint, ResponsiveRect, PageData, Section } from "../core/types";
export declare const getCanvasWidth: (breakpoint: Breakpoint, breakpoints: Record<Breakpoint, number>) => number;
export declare const scaleLayoutToBreakpoint: (sourceRect: LayoutRect, _sourceBreakpoint: Breakpoint, _targetBreakpoint: Breakpoint, _breakpoints: Record<Breakpoint, number>) => LayoutRect;
export declare const pixelsToResponsive: (rect: LayoutRect, _canvasWidth?: number, _canvasHeight?: number) => ResponsiveRect;
...
export declare const responsiveToPixels: (rect: ResponsiveRect, canvasWidth: number, canvasHeight?: number) => PixelRect;
...
export declare const gridPercentX: (gridSize: number, canvasWidth: number) => number;
export declare const gridPercentY: (gridSize: number, canvasHeight: number) => number;
