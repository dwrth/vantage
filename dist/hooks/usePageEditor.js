...
export function usePageEditor(pageId, config) {
    ...
    const { addElement: addElementAction, updateLayout: updateLayoutAction, deleteElement: deleteElementAction, updateZIndex: updateZIndexAction, ensureBreakpointLayout, } = usePageActions(pageData, setPageDataWithHistory, actionsOptions);
    // Undo/Redo handlers
    ...
    const addElement = useCallback((type, defaultContent) => {
